...
namespace RLX
{
    ...
    public class MechEquipFillTitle: IExternalCommand
    {
          ...
          ElementSet elements)
        {
            ...
            Document doc = uidoc.Document;
                ...
                IList<Element> mechEquipments = new FilteredElementCollector(doc, doc.ActiveView.Id).WherePasses(filter1).WhereElementIsNotElementType().ToElements();
                ...
                using (Transaction t = new Transaction(doc, "Fill params"))
                {
                    ...
                    foreach (Element element in mechEquipments)
                    {
