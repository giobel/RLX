...
namespace RLX
{
    ...
    public class ColorByRLXTitle : IExternalCommand
    {
          ...
          ElementSet elements)
        {
            ...
            var grouped = visibleElements.GroupBy(x => x.LookupParameter("RLX_Title").AsValueString());
            ...
            using (Transaction t = new Transaction(doc, "Override Colors"))
            {
                ...
                foreach (var element in grouped)
                {
                    ...
                    string colorName = firstElement.LookupParameter("RLX_Title").AsValueString();
