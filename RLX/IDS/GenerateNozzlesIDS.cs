...
namespace RLX
{
    ...
    public class GenerateNozzlesIDS : IExternalCommand
    {
          ...
          ElementSet elements)
        {
            ...
            IList<Element> velements = new FilteredElementCollector(doc, doc.ActiveView.Id).OfCategory(BuiltInCategory.OST_GenericModel).WhereElementIsNotElementType().ToElements();
            ...
            using (Transaction t = new Transaction(doc, "Generate Nozzles Ids"))
            {
                ...
                foreach (FamilyInstance fa in velements)
                {
